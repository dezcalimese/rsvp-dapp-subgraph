...
export class DepositsPaid extends ethereum.Event {
  get params(): DepositsPaid__Params {
    return new DepositsPaid__Params(this);
  }
}

export class DepositsPaid__Params {
  _event: DepositsPaid;

  constructor(event: DepositsPaid) {
    this._event = event;
  }
...
export class RSVP__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class RSVP extends ethereum.SmartContract {
  static bind(address: Address): RSVP {
    return new RSVP("RSVP", address);
  }

  idToEvent(param0: Bytes): RSVP__idToEventResult {
    ...
    return new RSVP__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(param0: Bytes): ethereum.CallResult<RSVP__idToEventResult> {
